...
const DropDown = ({ className }) => {
    ...
    return (
        <div className={`absolute top-[43px] min-w-[124px] right-0 max-w-max flex bg-white flex-col items-start border border-blue1 rounded-md dropdown-content ${show2 ? "open" : ""} ${className}`}>
