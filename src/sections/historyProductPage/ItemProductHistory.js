      ...
      <div className="flex items-center justify-between px-4 py-3 ">
        <div className="flex items-center gap-5">
          ...
          <button className="flex items-center gap-1 p-2 border border-blue6">
            ...
            >
              <path
                d="M5.28032 1H8.41285L8.82134 5.08294C8.84918 5.35898 8.81885 5.6378 8.73229 5.9014C8.64573 6.165 8.50486 6.40752 8.31879 6.61331C8.13271 6.81911 7.90555 6.9836 7.65197 7.09618C7.3984 7.20877 7.12403 7.26694 6.84659 7.26694C6.56914 7.26694 6.29478 7.20877 6.0412 7.09618C5.78762 6.9836 5.56047 6.81911 5.37439 6.61331C5.18831 6.40752 5.04745 6.165 4.96089 5.9014C4.87433 5.6378 4.84399 5.35898 4.87184 5.08294L5.28032 1Z"
                fill="#00C09E"
                stroke="#348879"
                strokeWidth="1.5"
              />
              <path
                d="M1.41478 3.09942C1.5263 2.54183 1.58206 2.26304 1.69546 2.03687C1.81361 1.80133 1.97998 1.59326 2.18376 1.42618C2.38753 1.2591 2.62417 1.13674 2.8783 1.06704C3.12264 1 3.40707 1 3.97594 1H5.28032L4.82611 5.53904C4.80214 5.7988 4.7254 6.05095 4.6006 6.28003C4.4758 6.50911 4.30555 6.71031 4.10029 6.87131C3.89503 7.03232 3.65907 7.14973 3.40686 7.21638C3.15464 7.28302 2.89148 7.29748 2.63348 7.25889C2.37547 7.22029 2.12807 7.12945 1.90639 6.99191C1.68472 6.85438 1.49345 6.67305 1.34429 6.45903C1.19513 6.24501 1.09122 6.0028 1.03892 5.74722C0.986622 5.49165 0.987033 5.22809 1.04013 4.97267L1.41478 3.09942ZM12.2784 3.09942C12.1669 2.54183 12.1111 2.26304 11.9977 2.03687C11.8796 1.80133 11.7132 1.59326 11.5094 1.42618C11.3056 1.2591 11.069 1.13674 10.8149 1.06704C10.5705 1 10.2861 1 9.71724 1H8.41285L8.86707 5.53904C8.89104 5.7988 8.96778 6.05095 9.09258 6.28003C9.21738 6.50911 9.38762 6.71031 9.59288 6.87131C9.79815 7.03232 10.0341 7.14973 10.2863 7.21638C10.5385 7.28302 10.8017 7.29748 11.0597 7.25889C11.3177 7.22029 11.5651 7.12945 11.7868 6.99191C12.0085 6.85438 12.1997 6.67305 12.3489 6.45903C12.498 6.24501 12.602 6.0028 12.6543 5.74722C12.7066 5.49165 12.7061 5.22809 12.653 4.97267L12.2784 3.09942Z"
                fill="#00C09E"
                stroke="#348879"
                strokeWidth="1.5"
              />
        ...
        <div>
          <span className="pr-3 border-r border-blue6 text-blue6">
            Đơn hàng thành công
          </span>
        ...
        <div className="border-b border-grayE8 bg-greenBorder bg-opacity-5">
          ...
          <div className="px-2 py-8">
            <div className="flex items-end justify-end w-full gap-4 pr-3">
              ...
              <span className="text-[20px] font-semibold text-blue7">
                200.000
              </span>
            </div>
            <div className="flex items-center justify-between pl-5 pr-3 mt-10">
              <div>
                <span className="italic font-[14px] text-gray1">
                  Đánh giá sản phẩm để nhận điểm tích lũy
                </span>
              </div>
              <div className="flex items-center gap-6">
                <button className="px-5 py-3 font-medium text-white border rounded-sm border-blue6 bg-blue6">
                  Đánh giá
                </button>
                <button className="px-5 py-3 font-medium bg-white border border-blue6 text-blue6">
                  Liên hệ người bán{" "}
                </button>
                <button
                  className="flex items-center gap-3 ml-6"
                  onClick={() => {
                    handleShowDetailPrice(1);
                  }}
                >
                  <span className="font-semibold">Chi tiết hóa đơn</span>
          ...
          <div
            className={`grid grid-cols-10 ${
              showDetailPrice[1]
                ? "dropDownShowDetailPriceProductHistory"
                : "hidden"
            }`}
          >
            <div className="flex flex-col col-span-7 text-right">
              <span className="px-3 py-3 border-t border-r border-grayE8">
                Tổng tiền hàng
              </span>
              <span className="px-3 py-3 border-t border-r border-grayE8">
                Voucher từ Duc Hai
              ...
              <span className="px-3 py-2 border-t border-r text-[18px] font-bold border-grayE8 text-blue7">
                Thành tiền
              </span>
              <span className="px-3 py-3 border-t border-r border-grayE8">
            ...
            <div className="flex flex-col col-span-3 text-right">
              ...
              <span className="px-3 py-2 font-bold border-t border-r border-grayE8 text-[18px] text-blue7">
                200.000
              </span>
              <span className="px-3 py-3 border-t border-r border-grayE8">
                Banking
...
export default ItemProductHistory;
