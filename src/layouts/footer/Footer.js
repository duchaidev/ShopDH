...
const Footer = () => {
    return (
        <div className='w-full h-[420px] bg-black flex justify-center mt-28'>
            <div className='w-[80%] py-10'>
                <div className='grid grid-cols-5'>
                    <div className='flex flex-col gap-5 text-blue1'>
                        <div className='flex items-center gap-2'>
                            <Logo height="48" width="60"></Logo>
                        ...
                        <div className='flex items-center gap-5'>
                            <NavLink to="/">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className='transition-all fill-blue1 hover:fill-blue6'>
                            ...
                            <NavLink to="/">
                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" className='transition-all fill-blue1 hover:fill-blue6'>
                                    ...
                                    <path fillRule="evenodd" clipRule="evenodd" d="M4 0C2.93913 0 1.92172 0.421427 1.17157 1.17157C0.421427 1.92172 0 2.93913 0 4V18C0 19.0609 0.421427 20.0783 1.17157 20.8284C1.92172 21.5786 2.93913 22 4 22H18C19.0609 22 20.0783 21.5786 20.8284 20.8284C21.5786 20.0783 22 19.0609 22 18V4C22 2.93913 21.5786 1.92172 20.8284 1.17157C20.0783 0.421427 19.0609 0 18 0H4ZM18 2H4C3.46957 2 2.96086 2.21071 2.58579 2.58579C2.21071 2.96086 2 3.46957 2 4V18C2 18.5304 2.21071 19.0391 2.58579 19.4142C2.96086 19.7893 3.46957 20 4 20H18C18.5304 20 19.0391 19.7893 19.4142 19.4142C19.7893 19.0391 20 18.5304 20 18V4C20 3.46957 19.7893 2.96086 19.4142 2.58579C19.0391 2.21071 18.5304 2 18 2Z" />
                                </svg>
                            </NavLink>
                            <NavLink to="/">
                                <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg" className='transition-all fill-blue1 hover:fill-blue6'>
                                    <path d="M18 0H2C0.9 0 0.00999999 0.9 0.00999999 2L0 14C0 15.1 0.9 16 2 16H18C19.1 16 20 15.1 20 14V2C20 0.9 19.1 0 18 0ZM18 4L10 9L2 4V2L10 7L18 2V4Z" />
                                </svg>
                            </NavLink>
                            <NavLink to="/">
                                <svg width="21" height="17" viewBox="0 0 21 17" fill="none" xmlns="http://www.w3.org/2000/svg" className='transition-all fill-blue1 hover:fill-blue6'>
                    ...
                    <div className='flex flex-col gap-5 mt-4 text-blue1'>
                        ...
                        <NavLink to="/" className='mt-3'>Affilate Partner</NavLink>
                        <NavLink to="/">Trở thành người bán</NavLink>
                    </div>
                    <div className='flex flex-col gap-5 mt-4 text-blue1'>
                        <h2 className='text-[22px] text-white font-semibold'>Về DH</h2>
                        <NavLink to="/" className='mt-3'>Giới thiệu</NavLink>
                    ...
                    <div className='flex flex-col gap-5 mt-4 text-blue1'>
                        <h2 className='text-[22px] text-white font-semibold'>Sản phẩm khác</h2>
                        <NavLink to="/" className='mt-3'>Web bán tương tác</NavLink>
                        <NavLink to="/">Game CSS Diner</NavLink>
                        <NavLink to="/">Game Froggy Pro</NavLink>
                        <NavLink to="/">Chia sẻ blog</NavLink>
                    </div>
                    <div className='flex flex-col gap-5 mt-4 text-blue1'>
                        <h2 className='text-[22px] text-white font-semibold'>CÔNG TY CỔ PHẦN CÔNG
                            NGHỆ DH</h2>
                        <NavLink to="/" className='mt-3'>Mã số thuế: 01234567</NavLink>
                        <NavLink to="/">Lĩnh vực: Công nghệ, lập trình,
                            MMO.</NavLink>
                    </div>
                </div>
