        ...
        <div className="mt-[35px]">
                ...
                <div className="grid grid-cols-4 gap-8 mt-[35px]">
                    <div className="py-[35px] flex gap-3 px-[15%] justify-center items-center flex-col shadow-md">
                        ...
                        <span className="text-center line-clamp-4 overflow-ellipsis">
                            Mark Simonson is an independent type designer based in Saint Paul,
                            Minnesota. In the past, he worked variously as a graphic d...
                        </span>
            ...
            <div className="mt-[50px]">
                ...
                <div className="flex items-center justify-between pr-4 border-b border-blue1">
                    <div className="flex">
                        <span
                            className={` transition-all px-5 ${isReview ? "border-blue7 text-blue7" : "border-transparent"
                        ...
                        <span
                            className={` transition-all ${isComment ? "border-blue7 text-blue7" : "border-transparent"
                        ...
                        <span
                            className={` transition-all ${isFAQs ? "border-blue7 text-blue7" : "border-transparent"
                                } px-5 pb-[10px] font-semibold border-b-[2px] cursor-pointer`}
                            onClick={() => {
                                setIsFAQs(true);
                                setIsComment(false);
                ...
                <div
                    className="bg-[#faf9fb] border border-[#d9d9d7] rounded-sm h-[100px] flex items-center mt-8"
                >
                ...
                {isReview === true ? (
                    <div className="w-[60%] mt-10 border border-blue1 rounded-sm px-14 pb-10">
